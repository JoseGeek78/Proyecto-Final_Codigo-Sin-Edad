  ...
  return (
    <section className="invitation">
      <h4 className="Invitation_title">
        ¡Nunca es tarde para adentrarse en el mundo de la programación!
      </h4>
      <p className="Invitation_paragraph">
        Descubre el emocionante viaje de aprender a programar sin importar la
